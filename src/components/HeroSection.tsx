...
import { Calendar, MapPin, Trophy, ChevronRight, Play } from "lucide-react";
...
export default function HeroSection({ featuredNews, upcomingMatch, loading = false }: HeroSectionProps) {
  return (
